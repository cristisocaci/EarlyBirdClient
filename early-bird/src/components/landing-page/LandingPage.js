    ...
    return (
        ...
        <div className="center-landing-page">
            ...
            You’ve come to the right place.</p>
                <div id="btn-landing">
                    <a id="lm" className="round bg-pink text-red py-2 px-3 text-bold" href="#hiw-scroll">Learn More</a>
                    <button className="round bg-red text-white py-2 px-2"  onClick={() => redirectTo('/register')}>Start your hustle</button>
                </div>
            </div>
